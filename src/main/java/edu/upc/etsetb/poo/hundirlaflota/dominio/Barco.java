...
public class Barco {
    ...
    protected Barco(String nombre, int lon) {
        ...
        this.posicionesTocadas= new HashSet<String>();
        this.hundido = false;
    }
    ...
    public static Barco creaBarco(String tipo, String nombre) {
       ...
       switch(tipo.toUpperCase()) {
        case "L":
            return new Lancha(nombre);
        case "C":
            return new Crucero(nombre);
        case "S":
            return new Submarino(nombre);
        case "B":
            return new Buque(nombre);
        case "P":
            return new Portaviones(nombre);
        default:
            return new Lancha(nombre);
    ...
    if (posicionesTocadas.size() == this.lon) {
        hundido = true;
    }
    }
