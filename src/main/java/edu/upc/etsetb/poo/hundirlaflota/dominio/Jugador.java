...
public abstract class Jugador {
    ...
    public String dondeHanDado(String posicion) {
         Barco disparo = tablero.getContenidoCasilla(posicion);
    if (disparo == null) {
        return Jugador.AGUA;
    } else if (disparo.hundiraEsteTocado(posicion)) {
     ...
     * si el usuario ha disparado antesa la posición pasada como argumento; en
