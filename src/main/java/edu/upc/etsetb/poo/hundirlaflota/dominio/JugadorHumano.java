    ...
    */
    ...
    public void anotaDisparoAjeno(String posDisparo, String resultado) {
        if(resultado.equals(Jugador.AGUA)){
            ...
            Barco barco = tablero.getBarcoEn(posDisparo);
            barco.addPosicionTocada(posDisparo);
            
        }
    }   

    /**Retorna true si el usuario ya ha disparado antes a la posición pasada como argumento (puede usarse el visor
    ...
    */
    @Override
        public boolean hasDisparadoAquiAntes(String posicion){
         return visorDeAtaque.get(posicion) != null;
    }
}
